<template>
  <div class="app-container complex-table">
    <div class="top-of-table">
      <div class="filter-container">
        <MoreScreener>
          <el-form :inline="true" class="common-form default-form" label-width="50px">
            <el-form-item label="标题">
              <el-input v-model="listQuery.title" placeholder="Title" style="width: 200px" class="filter-item" @keyup.enter.native="handleFilter" />
            </el-form-item>
            <el-form-item label="星标">
              <el-select v-model="listQuery.importance" placeholder="Imp" clearable class="filter-item">
                <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item" />
              </el-select>
            </el-form-item>
            <el-form-item label="类别">
              <el-select v-model="listQuery.type" placeholder="Type" clearable class="filter-item">
...
import MoreScreener from '@/components/MoreScreener/MoreScreener'
...
export default {
  name: 'ComplexTable',
  components: { Pagination, MoreScreener },
  directives: { waves },
  filters: {
    statusFilter(status) {
      const statusMap = {
