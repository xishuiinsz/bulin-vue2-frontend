<template>
  <div class="online-design-general-container">
    <div class="operation-area">
      <el-input-number v-model="currentScale" :precision="2" @change="scaleChange" :step="scaleStep" :max="4"
        :min="0.2"></el-input-number>
      ...
      <el-button-group>
        <el-button @click="() => { }" size="small" type="primary"> 裁剪框 </el-button>
        <el-button @click="() => { }" size="small" type="primary"> 开始裁剪 </el-button>
      </el-button-group>
    </div>
      ...
      <div class="drawing-board-container">
        <div class="drawing-canvas-container">
          <div class="drawing-canvas" :style="stageStyle">
            <div :data-layer-id="layer.id" :class="getLayerItemClass(layer)" v-for="layer in layerList" :key="layer.id"
              class="layer-item" :style="getLayerStyle(layer)">
